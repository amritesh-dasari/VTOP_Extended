                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
                    if(snapshot.hasError)
                      return new Text('Error ${snapshot.error}', style: TextStyle(color: Colors.white, fontSize: 18),);
                    switch(snapshot.connectionState){
                      case ConnectionState.waiting: 
                        return new SpinKitChasingDots(color: Colors.red, size: 50,);
                      default: 
                                    ...
                                    child: BackdropFilter(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Stack(
                                          children: [
                                            Padding(
                                              padding: EdgeInsets.only(bottom: 40, top: 150, left: 20),
                                              child: Text(
                                                '${docsSnap['text']}',
