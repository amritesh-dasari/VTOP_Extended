      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: 
              Container(margin: EdgeInsetsDirectional.only(start: MediaQuery.of(context).size.width/25),
                child: Text("Somsubro Banerjee", style:TextStyle(color:Colors.white, fontSize: 20, fontWeight: FontWeight.bold))
              )
          ),
          Container(
            margin: EdgeInsetsDirectional.only(
            ...
            child: 
              Container(margin: EdgeInsetsDirectional.only(start: MediaQuery.of(context).size.width/25),
                child: Text("somsubro.18BCE7011@vtiap.ac.in", style:TextStyle(color:Colors.white, fontSize: 20, fontWeight: FontWeight.bold))
              )
          ),
          Container(
            margin: EdgeInsetsDirectional.only(
            ...
            child: 
              Container(margin: EdgeInsetsDirectional.only(start: MediaQuery.of(context).size.width/25),
                child: Text("Branch: B Tech CSE", style:TextStyle(color:Colors.white, fontSize: 20, fontWeight: FontWeight.bold))
              )
          )
        ],
      ),
